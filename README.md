...
```r
install.packages(c("ape", "phytools", "caret", "caper", "geiger",
                   "dplyr", "tidyr", "tibble", "ggplot2", "gridExtra",
                   "mvtnorm", "MASS"))
# dilp is installed from GitHub, not CRAN:
# devtools::install_github("jboyko/dilp")
```
